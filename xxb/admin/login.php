        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3 col-xs-12 pt-5">
                ...
                <form method="post" class="form" id="myform">
                    ...
                    <input value="admin" type="text" name="name" id="name" value="" class="form-control" required>
                    <br>
                    <label for="pass">密码:</label>
                    <input value="123456" type="password" name="pass" id="pass" class="form-control" value="" required>
                    <br>
