...
<h1 class="mt-3" style="text-align:center"><?php echo $name;?></h1>
<form id="myform" class="form">
<div class="form-group">
      <textarea class="form-control" rows="5" id="content" placeholder="信息内容" maxlength="100"></textarea>
</div>
<?php
...
<?php } ?>
<div class="form-group"><button type="submit" class="btn btn-success btn-block">发布</button></div>
</form>
<div id="top">
...
<footer class="mb-5" style="text-align:center">©2020 信息板 <a href="admin/login.php">后台</a></footer>
</div>
