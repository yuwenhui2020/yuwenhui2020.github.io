...
{slug:"common",list:[
{tag:"热门",link:[
{name:"百度热门",url:"http://top.baidu.com/category?c=513"},
...
{tag:"资讯",link:[
{name:"网易新闻",url:"https://news.163.com/rank/"},
{name:"腾讯资讯",url:"http://www.qq.com/"},
{name:"新浪新闻",url:"http://www.sina.com.cn/"},
{name:"搜狐",url:"http://www.sohu.com/"},
{name:"凤凰网",url:"http://www.ifeng.com/"},
{name:"人民网",url:"http://news.sina.com.cn/hotnews/"},
...
{tag:"影视",link:[
{name:"爱丫丫",url:"http://iyayatv.com/vodtype/1.html"},
{name:"爱奇艺",url:"https://www.iqiyi.com/"},
{name:"极速影院",url:"https://www.jisuysw.com/"},
{name:"哔哩哔哩",url:"https://www.bilibili.com/"},
{name:"YouTube",url:"https://www.youtube.com/"},
{name:"斗鱼直播",url:"https://www.douyu.com/"},
{name:"虎牙直播",url:"https://www.huya.com/"}]},
{tag:"捷径",link:[
{name:"图片放大",url:"https://bigjpg.com/"},
{name:"图壳图床",url:"https://imgkr.com/"},
{name:"图片转换",url:"https://renzhezhilu.gitee.io/webp2jpg-online/"},
...
{tag:"工具",link:[
{name:"在线会议",url:"https://meet.jit.si/"},
{name:"音乐下载",url:"https://music.y444.cn/#/"},
{name:"拷贝兔",url:"https://cp.anyknew.com/"},
{name:"在线音乐",url:"https://tool.liumingye.cn/music/#/"},
{name:"图片编辑",url:"https://www.photopea.com/"},
{name:"云盘搜索",url:"https://www.wowenda.com/"},
...
{name:"文件传输",url:"https://cowtransfer.com/"},
...
{name:"Aminer",url:"http://www.aminer.cn/"}]},
{tag:"词典",link:[
...
{tag:"查询",link:[
{name:"网速测试",url:"http://www.speedtest.cn/"},
...
{name:"V2方圆",url:"https://www.v2fy.com/"},
...
{name:"Speedtest",url:"http://www.speedtest.cn/"},
...
{tag:"图库",link:[
{name:"花瓣",url:"http://huabanpro.com/"},
...
{tag:"素材",link:[
{name:"昵图网",url:"http://www.nipic.com/"},
...
var _hmt=_hmt||[];!function(){var e=document.createElement("script");e.src="https://hm.baidu.com/hm.js?";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}()
...
else if(o(t).hasClass("weibo"))o(".search-form").attr("action","https://s.weibo.com/weibo"),o(".search-keyword").attr({name:"q",placeholder:"新浪微博-随时随地发现新鲜事"})
...
else if(o(t).hasClass("jd"))o(".search-form").attr("action","https://search.jd.com/Search"),o(".search-keyword").attr({name:"keyword",placeholder:"京东-正品低价、品质保障、配送及时、轻松购物！"})
else if(o(t).hasClass("inprivate"))o(".search-form").attr("action","https://mijisou.com"),o(".search-keyword").attr({name:"q",placeholder:"国内版DuckDuckGO,聚合百度必应360搜狗的结果"})
...
var i=new Image
i.src="https://images.google.com/favicon.ico?"+Date.now(),i.onload=function(){o(".search-form").attr("action","https://www.google.com/search"),o(".search-form").prepend('<input class="search-hidden" type="hidden" name="tbm" value="isch">')}}else if(o(t).hasClass("geng")){o(".search-form").attr("action","https://jikipedia.com/search"),o(".search-keyword").attr({name:"phrase",placeholder:"网络流行梗搜索"})}else if(o(t).hasClass("github"))o(".search-form").attr("action","https://github.com/search"),o(".search-keyword").attr({name:"q",placeholder:"GitHub项目搜索"})
